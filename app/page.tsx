                ...
                <section id="about" className="py-24 border-b border-zinc-800 bg-[#09090b]">
                    <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
                        <div className="relative">
                            <div className="absolute top-4 left-4 w-full h-full border border-zinc-800 pointer-events-none"></div>
                            <img
                                src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=1000&q=80"
                                alt="Infrastructure"
                                className="w-full relative z-10 grayscale hover:grayscale-0 transition-all duration-500 border border-zinc-800"
                            />
                        </div>
                        <div>
                            <span className="mono text-cyan-500 text-xs tracking-widest mb-4 block">/// COMPANY_PROFILE</span>
                            <h2 className="text-4xl font-bold text-white font-['Space_Grotesk'] uppercase mb-8">
                            ...
                            <div className="grid grid-cols-2 gap-8 border-t border-zinc-800 pt-8">
                                <div>
                                    <div className="text-3xl font-bold text-white font-['Space_Grotesk']">500+</div>
                                    <div className="text-xs text-zinc-500 mono uppercase mt-1">Deployments</div>
                                </div>
                                <div>
                                    <div className="text-3xl font-bold text-white font-['Space_Grotesk']">100%</div>
                                    <div className="text-xs text-zinc-500 mono uppercase mt-1">Uptime SLA</div>
                                </div>
                            </div>
                        </div>
                    </div>
