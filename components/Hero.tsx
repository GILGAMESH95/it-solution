...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex items-center pt-16 border-b border-zinc-200 dark:border-zinc-800">
      <div className="container mx-auto px-6 grid lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-7">
          <div className="inline-block px-3 py-1 border border-zinc-300 dark:border-zinc-700 mb-8 bg-zinc-100/50 dark:bg-zinc-900/50">
            <span className="mono text-xs text-cyan-500 dark:text-cyan-400">/// ARCHITECTURE_SECURE_V3</span>
          </div>

          <h1 className="text-6xl lg:text-8xl font-bold text-zinc-900 dark:text-white leading-[0.9] mb-8 uppercase font-['Space_Grotesk']">
            Constructing <br />
          ...
          <p className="text-lg text-zinc-600 dark:text-zinc-400 mb-12 max-w-xl leading-relaxed border-l-2 border-zinc-300 dark:border-zinc-800 pl-6">
          ...
          <div className="flex flex-wrap items-center gap-6">
            ...
            <a
              href="#ai-consultant"
              className="px-8 py-4 border border-zinc-300 dark:border-zinc-700 text-zinc-900 dark:text-white font-bold uppercase tracking-widest hover:border-cyan-500 hover:text-cyan-500 transition-colors"
            >
              AI_Audit
            </a>
          </div>
